...
public interface SortedArrayListInterface<E> {
    ...
    // production class should have constructors with the same signatures
    // as the ones provided in ArrayList
     ...
     *                      if not found, and the value goes somewhere in the middle, a negative number
     *                          indicating where the value should be inserted, range: -(size-1) to -1;
     *                      if not found, and the value should  go at the start of the list, Integer.MIN_VALUE;
     *                      if not found, and the value should go at the end of the list, Integer.MAX_VALUE;
     */
